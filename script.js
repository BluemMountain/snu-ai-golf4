...
console.log("SNU AI GOLF Script Loaded v6.34");
function initRSVP() {
...
const GOLF_TEE_TIMES = {
    ...
    "6월|6.24": [
        "에벤에셀 13:22", "에벤에셀 13:30", "에벤에셀 13:37"
    ],
    "7월|7.22": [
        "크리크 14:25", "크리크 14:32"
    ],
    "8월|8.26": [
        "데이비드 13:22", "에벤에셀 13:22", "데이비드 13:30", "에벤에셀 13:30"
    ],
    "9월|9.30": [
        "데이비드 13:22", "데이비드 13:30", "솔로몬 13:30", "데이비드 13:37", "솔로몬 13:37"
    ],
    "10월|10.11": [
        "미정 13:00", "미정 13:07"
    ]
        ...
        sponsorHistory.forEach(data => {
            ...
            card.innerHTML = `
                <h3 style="margin-top: 0; color: #c5a059; border-bottom: 2px solid #f0f0f0; padding-bottom: 15px; margin-bottom: 15px; display: flex; justify-content: space-between; align-items: baseline; width: 100%;">
                    ${data.title}
                    <span style="font-size: 0.7rem; color: #ccc; font-weight: normal;">v6.34</span>
                </h3>
